(() => {
  ...
  const css = `
    .auth-layout{max-width:1240px!important;grid-template-columns:minmax(0,1fr) 500px!important;gap:72px!important;padding:34px 40px!important;background:transparent!important}
    ...
    .auth-brand h1:after{font-size:.84em!important;margin-top:5px!important}
    .auth-brand p{font-size:17px!important;max-width:610px!important;margin-bottom:28px!important}
    .auth-brand p:after{display:none!important}
    ...
    .auth-divider{display:flex;align-items:center;gap:12px;color:#8b93a1;font-size:10px;margin:17px 0 0}.auth-divider:before,.auth-divider:after{content:"";height:1px;background:#e7e9ed;flex:1}
    ...
    @media(max-width:650px){.auth-layout{padding:22px!important}.auth-brand{display:block!important}.auth-brand h1{font-size:40px!important}.auth-features{grid-template-columns:1fr}.auth-feature{border-right:0;border-bottom:1px solid #e5e8ee;padding:12px 0}.auth-feature:last-child{border-bottom:0}.auth-security{margin-bottom:8px}}
  `;
  function enhance(){
    ...
    const form=card.querySelector('form'); if(form){
      ...
      const legal=document.createElement('p');legal.className='auth-legal';legal.innerHTML='By creating an account, you agree to our <a href="#" onclick="return false">Terms of Service</a> and <a href="#" onclick="return false">Privacy Policy</a>.';form.appendChild(legal);
    }
  }
